...
class Form extends Component {
  ...
  postRequest() {
    let { productName, productPrice, productUrl } = this.state;
    // let { makeGetRequest } = this.props;
    axios
    ...
    return (
      <div className="form">
        ...
        <footer>
          ...
          <button
            // onClick={() => retreiveData(productName, productPrice, productUrl)}
